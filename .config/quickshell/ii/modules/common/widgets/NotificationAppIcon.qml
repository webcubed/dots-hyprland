    ...
    Loader {
        ...
        sourceComponent: Item {
            ...
            PlumpyIcon {
                ...
                name: plumpyFromGuess(parent.guessed)
                primaryColor: (root.urgency == NotificationUrgency.Critical) ? ColorUtils.mix(Appearance.m3colors.m3onSecondary, Appearance.m3colors.m3onSecondaryContainer, 0.1) : Appearance.m3colors.m3onSecondaryContainer
            }

            MaterialSymbol {
                anchors.centerIn: parent
                visible: !parent.usePlumpy || !notifPlumpy.available || notifPlumpy.name === ''
                text: parent.guessed
