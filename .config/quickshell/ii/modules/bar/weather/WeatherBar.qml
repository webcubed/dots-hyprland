    ...
    RowLayout {
        ...
        Item {
            ...
            PlumpyIcon {
                ...
                name: (plumpyFromWx(WeatherIcons.codeToName[Weather.data.wCode] ?? "") || 'cloud')
            ...
            MaterialSymbol { anchors.centerIn: parent; visible: wxPlumpy.name === ''; fill: 0; text: WeatherIcons.codeToName[Weather.data.wCode] ?? "cloud"; iconSize: parent.implicitWidth; color: Appearance.colors.colOnLayer1 }
        }
